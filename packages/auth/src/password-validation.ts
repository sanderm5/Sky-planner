...
const DEFAULT_OPTIONS: Required<Omit<PasswordValidationOptions, 'userContext'>> = {
  minLength: 10,
 ...
 */
function isSimilarToUserContext(password: string, context?: { email?: string; name?: string }): boolean {
