 ...
 */
export function generateTOTP(secret, timestamp) {
 ...
 */
export function verifyTOTPWithCounter(secret, code, window = 1) {
 ...
 */
export function hashBackupCode(code, hmacKey) {
 ...
 */
export function generateTOTPUri(secret, accountName, issuer = 'Sky Planner') {
