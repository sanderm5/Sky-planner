...
const icons: Record<string, string> = {
  ...
  phone: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />',
...
export default function FeatureIcon({ icon, className = '' }: FeatureIconProps) {
  const svgContent = icons[icon] || icons.check;

  return (
    <div className={clsx('w-12 h-12 rounded-xl bg-primary-500/10 flex items-center justify-center text-primary-400', className)}>
      <svg
        className="w-6 h-6"
        fill="none"
        stroke="currentColor"
