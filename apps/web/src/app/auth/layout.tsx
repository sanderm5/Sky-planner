...
export const metadata: Metadata = {
  description: 'Skyplanner - Logg inn eller opprett konto',
};
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="mountains-container" aria-hidden="true">
        {/* Far mountains with aurora glow */}
        <svg className="mountain-layer mountain-far" viewBox="0 0 1920 400" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="a-mtn-far" x1="0" y1="0" x2="0" y2="1">
        ...
        {/* Near mountains */}
        <svg className="mountain-layer mountain-near" viewBox="0 0 1920 400" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <main className="flex-1 flex items-center justify-center py-12 px-4 relative z-10">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <a href="/" className="inline-flex items-center gap-2 group" aria-label="Skyplanner - Gå til forsiden">
              ...
              <span className="text-2xl font-bold text-white group-hover:text-primary-400 transition-colors">Skyplanner</span>
            </a>
          </div>
      ...
      <footer className="py-6 text-center relative z-10">
        <p className="text-sm text-dark-400">
          &copy; {new Date().getFullYear()} Skyplanner. Alle rettigheter reservert.
        </p>
      </footer>
    </div>
  );
