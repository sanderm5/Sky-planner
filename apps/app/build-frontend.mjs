...
const SOURCE_FILES = [
  ...
  'frontend/services/route-service.js',
  'frontend/services/subscription.js',
  'frontend/services/websocket.js',
  'frontend/services/state-sync.js',
  ...
  'frontend/modules/mobile-weekplan-areas.js',
  'frontend/modules/arbeid-nav.js',
  'frontend/modules/route-assignment-overview.js',
  'frontend/modules/customer-note-popover.js',
  'frontend/modules/team-overview.js',
  'frontend/modules/onboarding-inline.js',
